<h1 align="center">Hi, I'm Manish Verma <img src='https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExc3Bxdm5qbzh6OWZxbTd2bnJvZ21zdWppcDc4MGxqaWV0Yjkxd3V4cSZlcD12MV9zdGlja2Vyc19zZWFyY2gmY3Q9cw/hDSGolpaNZTK9OQJqk/giphy.gif' width='40'></h1>
...
🚀 Passionate Android and iOS App Developer with a strong foundation in **Kotlin, React Native & Java Full Stack**. I enjoy building dynamic and scalable mobile & Web applications with an emphasis on **clean code, efficiency, and user experience**.
...
- Exploring **DSA and problem-solving**, with **750+ problems solved on LeetCode**
- Building scalable Web Apps using Spring Boot and React/Angular

🔍 Currently, I'm diving deep into **React Native for iOS, Java and Spring Boot with Angular for frontend** along with sharpening my **DSA skills**.

💼 Open to collaborations on **Cross Platform projects, Kotlin development, and innovative app and Web ideas**.
...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,java,kotlin,js,ts,angular,react,css,tailwind,androidstudio,vscode,webstorm,idea,figma,spring,firebase,postgres,mysql,git,github,gradle,stackoverflow,windows&perline=10)](https://skillicons.dev)
